    ...
    >
      ...
      <div className="text-center space-y-3 py-6">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white shadow-lg border border-sky-100"
        >
          <BookOpen className="w-3.5 h-3.5 text-sky-500" />
          <span className="text-sky-600 text-xs font-semibold">RAZ 精读</span>
